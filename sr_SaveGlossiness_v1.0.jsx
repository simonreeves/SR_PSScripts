...
var oOutputFile = new File( oCurrentDocPath + "/" + oCurrentDocName + "_Glossiness.png" )
...
var oOutputFile = new File( oCurrentDocPath + "/" + oCurrentDocName + "_Glossiness.jpg" )
...
// alert("Finished saving Glossiness:  " + oCurrentDocName + "_Glossiness.jpg" );
