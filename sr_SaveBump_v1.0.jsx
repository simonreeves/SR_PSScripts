...
var oOutputFile = new File( oCurrentDocPath + "/" + oCurrentDocName + "_Bump.png" )
...
var oOutputFile = new File( oCurrentDocPath + "/" + oCurrentDocName + "_Bump.jpg" )
...
// alert("Finished saving Bump:  " + oCurrentDocName + "_Bump.jpg" );
