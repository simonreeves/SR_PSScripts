...
var oOutputFile = new File( oCurrentDocPath + "/" + oCurrentDocName + "_Diffuse.png" )
...
var oOutputFile = new File( oCurrentDocPath + "/" + oCurrentDocName + "_Diffuse.jpg" )
...
// alert("Finished saving diffuse:  " + oCurrentDocName + "_Diffuse.jpg" );
