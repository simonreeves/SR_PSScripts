...
var oOutputFile = new File( oCurrentDocPath + "/" + oCurrentDocName + "_Transparency.png" )
...
var oOutputFile = new File( oCurrentDocPath + "/" + oCurrentDocName + "_Transparency.jpg" )
...
// alert("Finished saving Transparency:  " + oCurrentDocName + "_Transparency.jpg" );
