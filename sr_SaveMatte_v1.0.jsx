...
var oOutputFile = new File( oCurrentDocPath + "/" + oCurrentDocName + "_Matte.png" )
...
var oOutputFile = new File( oCurrentDocPath + "/" + oCurrentDocName + "_Matte.jpg" )
...
// alert("Finished saving Matte:  " + oCurrentDocName + "_Matte.jpg" );
